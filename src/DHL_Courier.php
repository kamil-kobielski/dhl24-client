...
class DHL_Courier extends SoapClient
{
    ...
    /**
     * Metoda pozwala na skasowanie przesyłki z systemu.
     *
     * @param $id
     *
     * @return mixed
    ...
    public function deleteShipment($id)
    {
        return $this->deleteShipment([
            'shipment' => [
                ...
                'dispatchIdentificationNumber' => $id
            ]
        ]);
    }

    /**
     * Metoda pozwala na skasowanie przesyłek z systemu.
     *
     * @param $id
     *
     * @return mixed
     ...
     * @param array $shipper Dane adresowe nadawcy paczki
     ...
     * @return array
     */
    public function bookCourierForCreatedShipments(
        string $pickupDate,
     ...
     * @return array
     */
    public function bookCourierWithoutDefinedShipments(
        string $pickupDate,
        string $pickupTimeFrom,
        string $pickupTimeTo,
        string $shipmentIdList,
        array $shipper,
        int $numberOfExPieces,
        int $numberOfDrPieces,
        int $totalWeight,
        int $heaviestPieceWeight,
        string $additionalInfo = null
    ) {
        $request = [
            'pickupDate' => $pickupDate,
     ...
     */
    public function getLabelsApi(array $itemsToPrint)
    {
